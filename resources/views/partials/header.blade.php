<nav class="navbar navbar-expand-lg navbar-light sticky-top" data-navbar-on-scroll="data-navbar-on-scroll">
    <div class="container"><a class="navbar-brand" href="index.html"><img src="{{ asset('landpage/assets/img/logo.svg') }}"
        ...
        <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto">
                ...
                @auth
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                class='bx bx-user-circle'></i> {{ auth()->user()->name }}</a>
                ...
                @else
                    <li class="nav-item"><a class="nav-link" aria-current="page" href="/login"><i class='bx bx-log-in'></i>
                            Login</a></li>
                @endauth
            </ul>
        </div> --}}
